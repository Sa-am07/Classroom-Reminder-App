...
$id = $_GET['id'];
$qry = "SELECT * FROM reminder WHERE Reminder_ID = $id";
$res = mysqli_fetch_array(mysqli_query($con,$qry));
$qry1 = "SELECT * FROM user WHERE Role = 2";
$pro = mysqli_query($con,$qry1);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <main class="container">
            <div class="form-container">
                <h2 class="text-center">Edit Reminder</h2>
                <form action="../PHP/edit_reminder.php" method="post" autocomplete="off" class="form">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select" required>
                            <option value="Assignment" <?php if($res['Category'] == "Assignment"){ echo "selected"; } ?> >Assignment</option>
                            <option value="Exam" <?php if($res['Category'] == "Exam"){ echo "selected"; } ?> >Exam</option>
                            <option value="Event" <?php if($res['Category'] == "Event"){ echo "selected"; } ?> >Event</option>
                        </select>
                    </div>
                    <div class="mb-3">
                ...
                <p class="text-center mt-3">Don't Edit Reminder? <a href="dashboard.php">Go Back</a></p>
            </div>
        </main>
